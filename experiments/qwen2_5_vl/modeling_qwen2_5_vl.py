...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        images_cd: torch.Tensor | None = None,
        cd_beta: torch.Tensor | float | None = None,
        cd_alpha: torch.Tensor | float | None = None,
        **kwargs: Unpack[TransformersKwargs],
    ...
    def prepare_inputs_for_generation_cd(
        ...
        **kwargs,
        ...
        # cd_comment: this hook mirrors older LVLM integrations in VCD.
        # It routes distorted image tensors (images_cd) into pixel_values so
        # the patched sampler can run the second (contrastive) forward branch.
        model_inputs = super().prepare_inputs_for_generation(
            ...
            inputs_embeds=inputs_embeds,
            position_ids=position_ids,
            pixel_values=kwargs.get("images_cd", pixel_values),
            pixel_values_videos=pixel_values_videos,
            image_grid_thw=image_grid_thw,
            video_grid_thw=video_grid_thw,
            second_per_grid_ts=second_per_grid_ts,
