...
class LlavaMistralForCausalLM(MistralForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        del images_cd, cd_beta, cd_alpha
...
try:
    AutoConfig.register("llava_mistral", LlavaMistralConfig, exist_ok=True)
except TypeError:
    AutoConfig.register("llava_mistral", LlavaMistralConfig)

try:
    AutoModelForCausalLM.register(LlavaMistralConfig, LlavaMistralForCausalLM, exist_ok=True)
except TypeError:
